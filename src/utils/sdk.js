...
/**
 * jump to youzan page and login automatically
 */
export const innerOpenYouZan = (url) => {
  url = encodeURIComponent(url)
  BH_MOBILE_SDK.UI.openWebView(`mamp://youzan?action=openPage&openUrl=${url}`)
}
 ...
 * 跳转到原生app - 我的今币页面
 */
export const gotoMyCoin = () => {
  openWindow('mamp://openActivity?ios=MyCoinController&android=com.wisorg.wisedu.plus.ui.coin.MyCoinActivity')
}
